...
from robot_sandbox.skills.catalog_loader import is_loopback_url
...
def create_face_task(face_server: str, skill_id: str, text: str = "", source: str = "robot_sandbox") -> dict[str, Any]:
    if not face_server:
